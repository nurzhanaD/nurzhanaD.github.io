...
export function Cat({img, id}) {
  ...
  return (
    <div className="cat">
        <img className='cat-img' src={img} alt="cat-img" />
        <div className="cat-btns">
          {
            localStorage.getItem(id) === null ?
            <button className="cat-unlike-btn" onClick={() => likeCat()} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
              {
                hover ?
            ...
            :
            <button className="cat-like-btn" onClick={() => unlikeCat()}>
              <svg width="40" height="37" viewBox="0 0 40 37" fill="none" xmlns="http://www.w3.org/2000/svg">
